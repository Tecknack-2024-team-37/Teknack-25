...
public class CarController101 : MonoBehaviour
{
    ...
    private void Update()
{
    ...
    if (inputVector.sqrMagnitude > 0.01f)
    {
        accelerationInput = inputVector.magnitude; // Normal case when moving
        steeringInput = inputVector.x;
    ...
    {
        accelerationInput = 0; // Stop when joystick is released
    }
    ...
    private void ApplyEngineForce()
{
    ...
    {
        carRigidbody2D.drag = 0; // Remove drag while accelerating
    }
